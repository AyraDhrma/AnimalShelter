	...
	<head>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="cats.html"> Adopt</a></p>
						</div>	
					</div>
				</div>
			</section>
		...
		<?php
		$id = $_GET['id'];
		$query = $db->query("SELECT * FROM image WHERE id='$id'") or die($db->error);
		if($query->num_rows){
			...
			echo '
					...
					<div class="row align-items-center">	
						<div class="col-lg-6 home-about-left no-padding">
							<img src="img/'.$row['filename'].'" alt="">
						</div>
						<div class="col-lg-6 home-about-right no-padding">
							<h1>
								'.$row['namapet'].'
							</h1>
							<h5>Breed : '.$row['breed'].'</h5>
							<p>
								'.$row['desk'].'
							</p>
						</div>
