				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="cats.php"> Adopt</a></p>
						</div>	
					</div>
				</div>
			</section>
						...
						<div class="gal">
							...
							if($query->num_rows){
								while($row = $query->fetch_assoc()){
									echo '<a href="foto.php?id='.$row['id'].'"><img src="img/'.$row['filename'].'" alt="X" class="responsive"></a>';
				...
				<div class="container">
					...
					<div class="row align-items-center justify-content-center">
						...
						<div class="buttons d-flex flex-row">
							<a href="voluntir.php" class="primary-btn text-uppercase">Register now</a>
						</div>
					</div>
				</div>	
			</section>
