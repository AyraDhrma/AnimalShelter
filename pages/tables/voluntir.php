			...
			<section class="Volunteer-form-area section-gap">
				<div class="container">
					...
					<div class="row justify-content-center">
						<form class="col-lg-9" action="simpan.php" method="POST">
						  <div class="form-group">
						    <label for="first-name">Full Name</label>
						    <input type="text" class="form-control" placeholder="Full Name" name="nama" id="nama" required>
						  </div>	
						  <div class="form-group">
						  ...
						  <div class="form-group">
						    <label for="phone">Phone Number</label>
						   	<input type="phone" class="form-control" placeholder="Phone Number" name="telp" id="telp" maxlength="13" required>
						  </div>	
